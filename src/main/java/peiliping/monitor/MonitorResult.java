...
public class MonitorResult {
     ...
     * @param duration
     */
    public MonitorResult(long in , long out , long success , long failure , long excep , long duration){
        this.in = in ;
        this.out = out ;
     ...
     * @param duration
     */
    public MonitorResult(MonitorResult mr,long in , long out , long success , long failure , long excep , long duration){
        this.in = in + mr.getIn();
    ...
    public String getSuccessPerCent(){
        return  ((out!=0) ? ( (double)success*100/out ) : 1) + "%"  ; 
    }
